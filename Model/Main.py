...
def training_test_validation(NUM_EPOCH):
    ...
    # Save the model
    model_trainer.save_model('CheckPoint/bert_model_tte.pt', 'CheckPoint/optimizer_tte.pt')
...
def Stratified_kfold_training(N_SPLIT, NUM_EPOCH):
    ...
    for fold, (train_texts, train_labels, test_texts, test_labels) in enumerate(data_handler.stratified_kfold_split_data()):
        ...
        model_trainer.save_model(f'Checkpoint/bert_model_stratified_fold_{fold + 1}.pt', f'CheckPoint/optimizer_stratified_fold_{fold + 1}.pt')
...
training_test_validation(5)
#KFold_training(10,5)
#Stratified_kfold_training(10,5)
